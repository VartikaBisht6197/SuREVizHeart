...
shinyFileChoose(input, "file", root = roots, filetypes = c("bed", "bw","bigwig","bigWig"))
...
observeEvent(input$file, {
    flog.info("User Input: Handel bw and bed files provided by the user")
    flog.info("Assuming root is '/'")
